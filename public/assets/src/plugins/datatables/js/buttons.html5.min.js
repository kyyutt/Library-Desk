...
(function (f) {
  ...
  v.ext.buttons.pdfHtml5 = {
    ...
    action: function (a, b, d, c) {
        ...
        // Ambil breadcrumbTitle
        var breadcrumbTitle = document
            .querySelector(".breadcrumb-item.active")
            .textContent.trim();

        // Set filename dynamically from breadcrumbTitle
        a.filename = breadcrumbTitle + ".pdf";  // Use breadcrumbTitle for the filename
        ...
        d = {
            ...
            content: [
                ...
                // Add table
                {
                    ...
                    margin: [20, 0, 20, 0], // Add margins to the table for centering
                },
            ],
            styles: {
                tableHeader: {
                ...
                tableBodyEven: {
                    alignment: "center", // Center content in even rows
                },
                tableBodyOdd: {
                    fillColor: "#f3f3f3",
                    alignment: "center", // Center content in odd rows
                },
                tableFooter: {
                    bold: true,
                    fontSize: 11,
                ...
                subtitle: { alignment: "center", fontSize: 12, color: "#666666" },
                message: {},
            },
